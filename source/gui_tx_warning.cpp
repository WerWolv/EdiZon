...
void GuiTXWarning::draw() {
  ...
  Gui::drawTextAligned(font20, Gui::g_framebuffer_width / 2, Gui::g_framebuffer_height / 2, COLOR_WHITE, "EdiZon detected that you're running the SX OS custom firmware. If this is true, please note that this\nmay cause unexpected failures, corruption of save data or backups, the Editor failing\nto load save files or configs and many other issues. For your own safety and the\n safety of your Switch, please use a free open source custom firmware instead.", ALIGNED_CENTER);
