...
WidgetList::WidgetList(Interpreter *saveParser, bool isDummy, std::vector<std::string> listItemNames, std::vector<s32> listItemValues) :
 Widget(saveParser, isDummy), m_listItemNames(listItemNames), m_intListItemValues(listItemValues) {
  m_widgetDataType = INT;
}

WidgetList::WidgetList(Interpreter *saveParser, bool isDummy, std::vector<std::string> listItemNames, std::vector<std::string> listItemValues) :
